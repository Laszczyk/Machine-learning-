...
results <- data.frame(MaxDepth = integer(1), TrainingAccuracy = numeric(0), TestAccuracy = numeric(0))
...
param_grid <- makeParamSet( 
  ...
  makeDiscreteParam("minsplit", values=1:100),
...
#usuniecie zmiennych ktore nie wnosza nic do modelu 
